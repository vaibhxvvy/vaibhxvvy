...
<!-- ============================================================ -->
<h3 id="01--about">01 — about &nbsp;<span style="color:#8B8DA3;font-weight:400;font-size:13px">systems, not just models</span></h3>
...
<img src="https://github-readme-activity-graph.vercel.app/graph?username=vaibhxvvy&theme=tokyo-night&bg_color=0A0A0F&color=8B8DA3&line=7A5CFA&point=7A5CFA&area=true&hide_border=true" width="100%" alt="activity"/>
...
<div align="center" style="border:1px solid #1C1E2A; border-radius:12px; padding:18px; background:#11131A">

<span style="color:#7A5CFA;font-family:'JetBrains Mono',monospace;font-size:11px;letter-spacing:1.4px">SUPPORT</span>

<h4 style="margin:6px 0 4px 0">If my work helped you — a coffee keeps the pipeline running.</h4>
<p style="color:#8B8DA3;font-size:13px;margin:0 0 12px 0">Open-source is free, but not free to make. Thanks for fuelling it.</p>

<a href="https://buymeacoffee.com/vaibhxvvy"><img src="https://img.shields.io/badge/Buy%20Me%20a%20Coffee-0A0A0F?style=for-the-badge&logo=buy-me-a-coffee&logoColor=ffdd00&labelColor=11131A&color=1C1E2A" alt="bmc"/></a>

...
<p style="color:#8B8DA3;font-size:11px;letter-spacing:.3px">custom dark · 0A0A0F / 7A5CFA → 00D9FF · animated pipeline + typing + fullsize 2D ripple · single-page scrolly</p>
